  ...
  return (
    <div className={styles.footerContainer}>
      <Container fluid className={styles.footerContainer}>
        <footer className={"page-footer font-small  pt-4"} className={styles.footer}>
            ...
            <div className="row">
              ...
              <div className="col-md-3 mb-md-0 mb-3">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a href="mailto: info@solrisingenergy.com.test-google-a.com">
                      info@solrisingenergy.com
                    </a>
                  </li>
                </ul>
              </div>
